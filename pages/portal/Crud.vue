...
async function reloadProducts () {
    ...
    products.value.unshift(...items.reverse());
}
            ...
            <div class="card">
                ...
                <DataTable
                    ...
                    <Column field="inventoryStatus" header="Detail" :sortable="true" headerStyle="width:8%; min-width:4rem;">
                        <template #body="slotProps">
                            <Button label="Detail" @click="navigateTo('/portal/detail/' + slotProps.data.code)" class="p-button-rounded p-button-primary mt-2 mr-2" />
                        </template>
                    </Column>
